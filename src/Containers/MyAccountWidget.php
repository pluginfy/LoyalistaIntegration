    ...
    public function call(Twig $twig, $arg)
    {
        ...
        if (isset($response['success']) && $response['success'] == true) {
            ...
            if ($user_registered) {
                ...
                $data['lang'] = $lang;
                return $twig->render('LoyalistaIntegration::content.container.MyAccountWidget_registered', $data);
            } else {
                $data['offer'] = $config_helper->getVar('my_account_text_for_unregistered_user_' .$lang);
                $data['btn_label'] = ($lang == 'de') ? 'Teilnehmen!' : 'Participate' ;
                $data['lang'] = $lang;
                return $twig->render('LoyalistaIntegration::content.container.MyAccountWidget_unregistered', $data);
